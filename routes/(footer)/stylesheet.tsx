  ...
  return (
    <div class="max-w-prose text-lg">
      ...
      <Text>
        ...
        <p>
          Each version of RFUI has it's own stylesheet. For example, v0.1.6 has
          {" "}
          <InlineCode>https://rfui.deno.dev/rfui-v0-1-6.css</InlineCode>. So the
        ...
        <CodeBlock
          ...
          code={`<link
  rel="stylesheet"
  href="https://rfui.deno.dev/rfui-v0-1-6.css"
/>`}
        />
        <p>
          But then you'll have to remember to update this when you upgrade to a
          new version of RFUI. For example, if you upgrade to v0.1.7 of RFUI
          you'll neeed{" "}
          <InlineCode>https://rfui.deno.dev/rfui-v0-1-7.css</InlineCode>. It can
          be easy to forget to do this.
        </p>
        <p>
          So an alternative is to use RFUI's{" "}
          <InlineCode>getStylesheetUrl</InlineCode>{" "}
          function. If you are on v0.1.6 of RFUI,{" "}
          <InlineCode>getStylesheetUrl</InlineCode> will return{" "}
          <InlineCode>"https://rfui.deno.dev/rfui-v0-1-6.css"</InlineCode>. So
...
<link rel="stylesheet" href={getStylesheetUrl()} />`}
        />
        <p>
          Then when you upgrade to v0.1.7,{" "}
          <InlineCode>getStylesheetUrl</InlineCode> will return{" "}
          <InlineCode>https://rfui.deno.dev/rfui-v0-1-7.css</InlineCode>{" "}
