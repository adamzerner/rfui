...
export default () => {
    ...
    notes: (
      <div>
        <div class="leading-relaxed">
          ...
          <Link href="https://github.com/adamzerner/rfui/blob/master/components/preact/atoms/button.tsx">
  ...
  return (
    <ComponentDocsPage
      ...
      sourceCodeUrl="https://github.com/adamzerner/rfui/blob/master/components/preact/atoms/button.tsx"
      sections={sections}
      props={props}
    />
  );
