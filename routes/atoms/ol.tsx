...
export default () => {
    ...
    notes: (
      <div>
        <div class="leading-relaxed">
          ...
          <Link href="https://github.com/adamzerner/rfui/blob/master/components/preact/atoms/ol.tsx">
  ...
  return (
    <ComponentDocsPage
      componentName="OL"
      sourceCodeUrl="https://github.com/adamzerner/rfui/blob/master/components/preact/atoms/ol.tsx"
      sections={sections}
      props={props}
    />
  );
