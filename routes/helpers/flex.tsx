...
export default () => {
    ...
    notes: (
      <div>
        <div class="leading-relaxed">
          ...
          <Link href="https://github.com/adamzerner/rfui/blob/master/components/preact/molecules/flex.tsx">
  ...
  return (
    <ComponentDocsPage
      componentName="Flex"
      sourceCodeUrl="https://github.com/adamzerner/rfui/blob/master/components/preact/helpers/flex.tsx"
      sections={sections}
      props={props}
    />
  );
